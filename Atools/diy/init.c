...
void clean_modem_state(int flag){
	...
	nvram_unset("usb_modem_act_sinr");
...
#if (defined(PLN11) || defined(PLN12) || defined(PLAC56) || defined(PLAC66U) || defined(RTAC82U) || defined(RTAC58U) || defined(RT4GAC53U))
...
//		nvram_set_int("led_2g_gpio", 72|GPIO_ACTIVE_LOW);
	...
	case MODEL_RTAC1200HP:
		...
		nvram_set_int("btn_rst_gpio",  GPIO_ACTIVE_LOW);
	...
	case MODEL_RT4GAC53U:
		...
		//nvram_set("vlan2hwname", "et0");  // vlan. used to get "%smacaddr" for compare and find parent interface.
		nvram_set("lan_ifname", "br0");
		set_basic_ifname_vars("eth2", "eth1", "ath0", "ath1", "usb", "eth1", NULL, NULL, NULL, 0);
